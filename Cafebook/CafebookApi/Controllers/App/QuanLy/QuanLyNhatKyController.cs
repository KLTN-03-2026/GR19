...
namespace CafebookApi.Controllers.App.QuanLy
{
    ...
    public class QuanLyNhatKyController : ControllerBase
    {
        ...
        {
            var query = _context.Set<NhatKyHeThong>().Include(n => n.NhanVien).AsNoTracking().AsQueryable();
            ...
            // ĐÃ FIX CẢNH BÁO CS8602 TẠI ĐÂY: Thêm check n.DuLieuMoi != null
            ...
            var data = await query.OrderByDescending(n => n.ThoiGian).Take(500)
                ...
                {
                    IdNhatKy = n.IdNhatKy,
                    TenNhanVien = n.NhanVien != null ? n.NhanVien.HoTen : "Hệ thống",
        ...
        {
            var n = await _context.Set<NhatKyHeThong>().Include(x => x.NhanVien).FirstOrDefaultAsync(x => x.IdNhatKy == id);
