...
namespace AppCafebookApi.View.quanly.pages
{
    public partial class QuanLyPhuThuView : Page
    {
        ...
        private async void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (!AuthService.CoQuyen("FULL_ADMIN", "FULL_QL") && !AuthService.CoQuyen("QL_PHU_THU")) 
            { 
                MessageBox.Show("Bạn không có quyền truy cập module Phụ thu!", "Từ chối", MessageBoxButton.OK, MessageBoxImage.Warning); 
            ...
            {
                Console.WriteLine($"Lỗi tại module Phụ thu: {ex.Message}");
            }
        }
        ...
        private async Task LoadDataAsync()
        {
            ...
            try
            {
                var res = await ApiClient.Instance.GetFromJsonAsync<List<QuanLyPhuThuGridDto>>("api/app/quanly-phuthu");
        ...
        private async void BtnLuu_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                var res = _isAdding ? await ApiClient.Instance.PostAsJsonAsync("api/app/quanly-phuthu", dto) : await ApiClient.Instance.PutAsJsonAsync($"api/app/quanly-phuthu/{_selectedItem!.IdPhuThu}", dto);
        ...
        private async void BtnXoa_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                var res = await ApiClient.Instance.DeleteAsync($"api/app/quanly-phuthu/{_selectedItem.IdPhuThu}");
